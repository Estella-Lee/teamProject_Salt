...
function dbg() {
    moreBtn.addEventListener("click", function () {
        ...
        moreImg.classList.remove("disappear");
        moreImg.classList.add("appear")
        moreBtn.classList.add("hidden");
        closeBtn.classList.remove("hidden");
    });

    closeBtn.addEventListener("click", function () {
        if (moreImg.classList.contains("appear")) {
            moreImg.classList.add("disappear");
            setTimeout(function () {
                moreImg.classList.remove("appear")
...
function dbg2() {
    moreBtn2.addEventListener("click", function () {
        moreVid.classList.remove("disappear");
        moreVid.classList.add("appear")
        moreBtn2.classList.add("hidden");
        closeBtn2.classList.remove("hidden");
    });

    closeBtn2.addEventListener("click", function () {
        if (moreVid.classList.contains("appear")) {
            moreVid.classList.add("disappear");
            setTimeout(function () {
                moreVid.classList.remove("appear")
